    ...
    <div class="row bg-primary" style="height: 100vh;">
        <div class="col-xl-4 p-4" style="height: 100%; background: #fff;">
            ...
            <div class="col-xl-12 mt-4">
                ...
                <form action="<?= base_url('/siswa_login'); ?>" method="POST">
                    <?= csrf_field(); ?>
                    <div class="mt-3">
                        <label for="user_id" style="font-weight: 500;">NIS:</label>
                        <input type="text" class="form-control" name="user_id" id="user_id" value="<?= old('user_id'); ?>" style="border-radius: 5px; height: 50px;" placeholder="Masukkan NIS anda">
                    </div>
        ...
        <div class="col-xl-8 p-0 bg-warning d-xl-block d-none" style="height: 100%;">
            <img src="<?= base_url('img/bg.png'); ?>" style="height: 100%; width: 100%; object-fit: cover;">
        </div>
    </div>
</div>
